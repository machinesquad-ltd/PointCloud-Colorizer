...
namespace Colorizer
{
    //The code for this LatLongUTMConverter was found here https://github.com/owaremx/LatLngUTMConverter/blob/master/LatLngUTMConverter.cs

    class LatLngUTMConverter
    {
        public class LatLng
        {
